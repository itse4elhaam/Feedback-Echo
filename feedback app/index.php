...
<h2>Feedback</h2>
<p class="lead text-center">Leave feedback for TrueDevs</p>
<form method="POST" action="<?= htmlspecialchars($_SERVER['PHP_SELF']) ?>" class="mt-4 w-75">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control <?= $bodyErr ? 'is-invalid' : "" ?>" id="body" name="body" placeholder="Enter your feedback"></textarea>
        <div class="invalid-feedback">
            <?= $bodyErr ?>
        </div>
    </div>
